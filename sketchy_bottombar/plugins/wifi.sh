...
POPUP_OFF="sketchy_bottombar --set wifi popup.drawing=off"
POPUP_CLICK_SCRIPT="sketchy_bottombar --set wifi popup.drawing=toggle"
...
render_popup() {
  ...
  sketchy_bottombar "${args[@]}" >/dev/null
}
...
popup() {
  sketchy_bottombar --set "$NAME" popup.drawing="$1"
}
...
# click_script="sketchy_bottombar --set wifi.alias popup.drawing=toggle; $WIFI_CLICK_SCRIPT" \
