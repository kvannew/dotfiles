...
POPUP_OFF='sketchy_bottombar --set logo popup.drawing=off'
...
logo=(
  ...
  label.drawing=off
  popup.align=left
  click_script="sketchy_bottombar --set logo popup.drawing=toggle"
...
logo_refresh=(
  "${menu_item_defaults[@]}"
  icon=􀅈
  label="Refresh sketchy_bottombar"
  click_script="$POPUP_OFF; sketchy_bottombar --update"
)
